...
/****** Object:  Database [LiveJourneysDb]    Script Date: 3/10/2018 10:39:19 AM ******/
CREATE DATABASE [LiveJourneysDb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'LiveJourneysDb', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\LiveJourneysDb.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'LiveJourneysDb_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\LiveJourneysDb_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [LiveJourneysDb] SET COMPATIBILITY_LEVEL = 140
GO
